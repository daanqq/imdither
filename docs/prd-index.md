...
- `evaluated` - planned evaluation completed with documented ship, defer, or
  reject outcomes.
...
| done   | [Phase 4.1 Effect Stack Core](market-impact-roadmap/phase-4-effect-stack-core/PRD.md)                                   | Serializable Effect Stack in Editor Settings.                                  |
| done   | [Phase 4.2 Effect Stack UI](market-impact-roadmap/phase-4-effect-stack-ui/PRD.md)                                       | Inspector Manual tab and stage editing workflow.                               |
| done   | [Phase 4.3 First Effects](market-impact-roadmap/phase-4-first-effects/PRD.md)                                           | First deterministic pre and post effects.                                      |
...
| done | [Preview Stage Application](../.scratch/preview-stage-application/PRD.md)                      | Preview Stage model and commands for the outer preview shell interface.                              |
