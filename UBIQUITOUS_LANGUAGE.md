...
| **Preview Job**       | A cancellable processing run that updates the on-screen **Preview**.                          | Worker job, render job                     |
| **Export Job**        | A processing run that produces **Export PNG** from **Full Output**.                           | Download job, final job                    |
...
- A **Preview Job** may be cancelled by newer edits.
- An **Export Job** should ignore preview-size shortcuts and produce **Export PNG** at **Output Size**.

## Example dialogue

> **Dev:** "When a phone user loads a 1920px **Source Image**, should we show a **Desktop Reduced Preview Notice**?"
>
...
>
> **Dev:** "Does that mean **Export PNG** uses the reduced buffer?"
>
> **Domain expert:** "No. **Reduced Preview** is only for the **Preview**; **Export PNG** must still come from **Full Output** at **Output Size**."
>
> **Dev:** "On desktop, should **Preview Only** remain the label?"
>
> **Domain expert:** "No. Use **Desktop Reduced Preview Notice** language and avoid **Preview Only** because it sounds like the editor is stuck."
>
